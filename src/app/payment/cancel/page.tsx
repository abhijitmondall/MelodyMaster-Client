    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950 p-4">
      ...
      <div className="relative w-full max-w-md space-y-4">
          ...
          <CardContent className="p-8 space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                You cancelled the Stripe checkout. Your class is still saved in your cart —
                no charge was made.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-amber-50 border border-amber-100 p-4 text-sm text-amber-800 text-left space-y-1.5">
              ...
              <p className="text-xs leading-relaxed text-amber-700">
                The class you were about to pay for is still in your Selected Classes.
                You can return and try again whenever you are ready.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              <Button variant="ghost" asChild className="rounded-xl text-muted-foreground text-sm">
        ...
        <p className="text-center text-xs text-slate-500 mt-4">
          ...
          <a href="mailto:hello@melodymasters.com" className="text-teal-400 hover:underline">
